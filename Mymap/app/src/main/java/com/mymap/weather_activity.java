...
public class weather_activity extends AppCompatActivity implements WeatherSearch.OnWeatherSearchListener {
        ...
        private String cityname="长沙市";//天气搜索的城市，可以写名称或adcode；
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            toolbar.setBackgroundColor(Color.parseColor("#548ED4"));
        ...
        public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult , int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {
                if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                  ...
                  //  ToastUtil.show(weather_activity.this, R.string.no_result);
                }
            }else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                itent.setClass(weather_activity.this, MainActivity.class);
                startActivity(itent);
